...
const  SearchForDetails=()=>
{
  ...
  const Search=()=>{
    axios.get(`https://localhost:44317/api/Values/${PaymentId}`)
    .then((Data)=>{
      setResult(Data.data);
    })
                  ...
                  <TableBody>
                    <TableRow key={result.PaymentId}
                      ...
                      >
                        ...
                        <TableCell align="center" style={{fontWeight:'bold',fontsize:'16px'}}>{result.PatientBillId}</TableCell>
                        ...
                        <TableCell align="center" style={{fontWeight:'bold',fontsize:'16px'}}>{result.TotalBill}</TableCell>
